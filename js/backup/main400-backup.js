...
const Configuration = {
    ...
    makeBaseList(filteredResult) {
        ...
        let selectedThing = selectBox.options[selectBox.selectedIndex];
        selectedThing.removeEventListener('mousemove', bad);
        selectBox.scroll({ top: 0 });
    ...
    makeMouseInListener(hoverClass, elemContainer, indexContext) {
        ...
        option.addEventListener('mousemove', bad = function(e) {
